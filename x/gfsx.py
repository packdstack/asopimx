...
class XGadget(Gadget):
    ...
    def __enter__(self):
        ...
        self.gadget.bcdDevice = '0x0101' # 1.01
        self.gadget.idVendor = '0x0079' # self.vid
        self.gadget.idProduct = '0x18d3' # self.pid

        # os desciptor (example)
        self.gadget.os_desc.use = '1'
        self.gadget.os_desc.b_vendor_code = '0x90'
        ...
        self.gadget.strings['0x409'].product = 'Magic-NS X' # self.product (this will be shown when using mtp)
